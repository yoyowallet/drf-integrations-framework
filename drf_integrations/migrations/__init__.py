"""
As the original oauth2_provider models are overwritten and users are forced to inherit
from the new models here in drf_integrations, every migration in oauth2_provider must be
